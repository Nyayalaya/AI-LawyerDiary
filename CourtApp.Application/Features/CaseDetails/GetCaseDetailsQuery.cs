...
{
    public class GetCaseDetailsQuery : IRequest<Result<PaginatedResult<CaseDetailResponse>>>
    {
    ...
    public class GetCaseDetailsQueryHandler : IRequestHandler<GetCaseDetailsQuery, Result<PaginatedResult<CaseDetailResponse>>>
    {
        ...
        public GetCaseDetailsQueryHandler(ICaseCategoryCacheRepository repoNature,
        ...
        public async Task<Result<PaginatedResult<CaseDetailResponse>>> Handle(GetCaseDetailsQuery request, CancellationToken cancellationToken)
        {
            ...
            var paginatedResult = results.ToPaginatedResult(request.PageNumber, request.PageSize);
            return Result<PaginatedResult<CaseDetailResponse>>.Success(paginatedResult);
        }
