...
{
    public class UpdateCaseHearingDatesCommand : IRequest<Result<string>>
    {
    ...
    public class UpdateCaseHearingDatesCommandHandler : IRequestHandler<UpdateCaseHearingDatesCommand, Result<string>>
    {
        ...
        public async Task<Result<string>> Handle(UpdateCaseHearingDatesCommand request, CancellationToken cancellationToken)
        {
            ...
            if (result == -1)
                return await Result<string>.FailAsync("There are issues to updated the selected record!");
            return await Result<string>.SuccessAsync("Selected records updated successfully!");
