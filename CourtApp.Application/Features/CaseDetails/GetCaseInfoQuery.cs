...
{
    public class GetCaseInfoQuery : IRequest<Result<PaginatedResult<GetCaseInfoDto>>>
    {
    ...
    public class GetCaseInfoQueryHandler : IRequestHandler<GetCaseInfoQuery, Result<PaginatedResult<GetCaseInfoDto>>>
    {
        ...
        public async Task<Result<PaginatedResult<GetCaseInfoDto>>> Handle(GetCaseInfoQuery request, CancellationToken cancellationToken)
        {
            ...
            var paginatedResult = await distinctQuery.ToPaginatedListAsync(request.PageNumber, pageSize);
            return Result<PaginatedResult<GetCaseInfoDto>>.Success(paginatedResult);
